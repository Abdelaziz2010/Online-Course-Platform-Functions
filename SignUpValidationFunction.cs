...
public class SignUpValidationFunction
{
    ...
    public SignUpValidationFunction(HttpClient httpClient, IConfiguration configuration,
        ILogger<SignUpValidationFunction> logger)
    {
        ...
        [HttpTrigger(AuthorizationLevel.Function, "post", Route = null)] HttpRequest req, ILogger log)
    {
        ...
        if (data == null)
        {
            return (ActionResult)new OkObjectResult(new ResponseContentDTO("ShowBlockPage", "There was a problem with your request."));
        }
        ...
        {
            return (ActionResult)new OkObjectResult(new ResponseContentDTO("ShowBlockPage", "Email name is mandatory."));
        }
        ...
        {
            return (ActionResult)new BadRequestObjectResult(new ResponseContentDTO("ValidationError", "Please provide a Display Name with at least five characters."));
        }
        ...
        var responseToReturn = new ResponseContentDTO()
        {
            //jobTitle = "This value return by the API Connector",// this jobTitle is in built attribute, you can change that value as well
    ...
    private async Task<ProfileDTO> CallUpdateUserProfileFunction(ProfileDTO profile)
    {
        try
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                return JsonConvert.DeserializeObject<ProfileDTO>(responseBody);
            }
